...
vlog -vlog01compat -work work +incdir+. {control_min_1200mv_-40c_fast.vo}

vlog -vlog01compat -work work +incdir+C:/Quartus/MIPS_CPU/MIPS_CPU/Control {C:/Quartus/MIPS_CPU/MIPS_CPU/Control/control_TB.v}
